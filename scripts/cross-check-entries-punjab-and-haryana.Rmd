---
title: "Data verificaiton report for Punjab and Haryana High Court"
subtitle: 
output: 
  html_document:
    df_print: default
...
court_name_index <- which(court_name_index == "Punjab and Haryana")
```
...
total_judges %>% kbl() %>% kable_material(lightable_options = "striped") %>% row_spec(row = nrow(total_judges), background = "#CEE397",bold = T)
```
